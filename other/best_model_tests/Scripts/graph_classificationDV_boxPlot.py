...
if __name__ == "__main__":
    ...
    create_box_plot(max_dv_data,labels,colors,dot_colors,yLabel="Decision Value at Predicted Cutsite\n(Best Replicate Applied to Test Set)",title="Maximum Decision Values for Cleavage-Site Predictions",include_dots=DVMAX_GRAPH_INCLUDE_DOTS,output_file=output_prefix + "_max_dv_boxPlot.svg")
