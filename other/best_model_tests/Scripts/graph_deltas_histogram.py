...
if __name__ == "__main__":
    ...
    for c in cutsites:
        plt.plot(lb_xVals,lb_yVals[c],linewidth=cutsite_linewidth,linestyle='-',color=colors[c],alpha=alpha)
        plt.plot([lb_xVals[-1],lb_xVals[-1]],[0,lb_yVals[c][1]],linewidth=cutsite_linewidth,linestyle='-',color=colors[c],alpha=alpha)
        plt.plot([lb_xVals[-1],hist_xVals[0]],[lb_yVals[c][-1],hist_yVals[c][0]],linewidth=dot_linewidth,linestyle=':',color=colors[c],alpha=alpha)
        plt.plot([hist_xVals[0],hist_xVals[0]],[0,hist_yVals[c][0]],linewidth=cutsite_linewidth,linestyle='-',color=colors[c],alpha=alpha)
        plt.plot(hist_xVals,hist_yVals[c],linewidth=cutsite_linewidth,linestyle='-',color=colors[c],alpha=alpha)
        plt.plot([hist_xVals[-1],hist_xVals[-1]],[0,hist_yVals[c][-1]],linewidth=cutsite_linewidth,linestyle='-',color=colors[c],alpha=alpha)
        plt.plot([hist_xVals[-1],ub_xVals[0]],[hist_yVals[c][-1],ub_yVals[c][-1]],linewidth=dot_linewidth,linestyle=':',color=colors[c],alpha=alpha)
        plt.plot([ub_xVals[0],ub_xVals[0]],[0,ub_yVals[c][0]],linewidth=cutsite_linewidth,linestyle='-',color=colors[c],alpha=alpha)
        plt.plot(ub_xVals,ub_yVals[c],linewidth=cutsite_linewidth,linestyle='-',color=colors[c],alpha=alpha)
    ...
    plt.xlabel("Positional Shift Error",fontsize=14)
    plt.ylabel("Frequency of Predictions\n(Best Replicate Applied to Test Set)",fontsize=14)
    for c in cutsites:
